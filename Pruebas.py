...
class FileProcessorApp(QWidget):
    ...
    def initUI(self):
        ...
        self.load_button.setStyleSheet("background-color: darkgreen; color: white;")
        self.load_button.clicked.connect(self.load_file)
        self.layout.addWidget(self.load_button)

        # Botón para procesar
        self.process_button = QPushButton("Procesar Archivo")
        self.process_button.setStyleSheet("background-color: darkgreen; color: white;")
        ...
        self.export_button.setStyleSheet("background-color: orange; color: white;")
